...
The F function is plotted with and without the *correction = "best"* argument as F_CK and F_CK_best. This argument for edge correction is optional in estimating F(r) and includes "none", "rs", "km", "cs" and "best". Alternatively *correction ="all"* selects all options.
...
Red line: Theoretical function (Poisson reference)
...
Blue line: Theoretical function (Poisson reference)
Black line: Observed data
