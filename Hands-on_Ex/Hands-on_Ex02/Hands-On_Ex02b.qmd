...
Unlike the earlier G and F function tests, the K function tests has a *global=TRUE* argument. This evaluates whether the observed spatial point pattern deviates from the simulation globally across all distance values (r) while tracking local significance.
...
Similar to the K function tests, the *global=TRUE* argument is used for L function tests.
:::
